...
const Task = ({
    ...
    const handleDeleteTask = () => {
        ...
        .then((result) => {
            if (result.isConfirmed) {
                axios.delete(`http://localhost:9090/api/v1/todo/task/${id}`)
                .then(() => {
                    MySwal.fire({
                        title: 'Task deleted',
                        icon: 'success',
    ...
    const handleEditTask = () => {
        MySwal.fire({
            ...
            preConfirm: () => {
                ...
                axios.put(`http://localhost:9090/api/v1/todo/task/${id}`, data)
                .then(() => {
                    MySwal.fire({
                        title: 'Task edited',
                        icon: 'success',
    ...
    const handleDoneTask = () => {
        axios.post(`http://localhost:9090/api/v1/todo/task/${id}/done`)
        .then(() => {
            MySwal.fire({
                title: 'Task done',
                icon: 'success',
    ...
    const handleUndoneTask = () => {
        axios.put(`http://localhost:9090/api/v1/todo/task/${id}/undone`)
        .then(() => {
            MySwal.fire({
                title: 'Task undone',
                icon: 'success',
        ...
        <>
            ...
            >
                ...
                <td>
                    <Form.Check 
                        checked={isDone}
                        onChange={isDone ? handleUndoneTask : handleDoneTask}>
                    </Form.Check>
                </td>
