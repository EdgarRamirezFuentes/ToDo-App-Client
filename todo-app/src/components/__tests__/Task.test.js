...
describe('Task', () => {
    test('calls handleDeleteTask when delete button is clicked', async () => {
        ...
        MySwal.fire.mockResolvedValue({ isConfirmed: true }); // Simular confirmación
        ...
        await act(async () => {
          ...
          await new Promise((resolve) => setTimeout(resolve, 0)); // Esperar a que se resuelva la promesa interna en handleDeleteTask
        });
